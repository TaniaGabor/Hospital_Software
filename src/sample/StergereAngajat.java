...
public class StergereAngajat implements Initializable {
    Connection con = null;
    ...
    public void stergere_angajat(  String nume1,String prenume1 )
    {

        try {

            CallableStatement deleteAngajat = con.prepareCall("{call stergereAngajat(?,?)}");
            ...
            mesaj.setText("Angajat sters cu succes!");
    ...
    public void handleButtonDate1Action(MouseEvent event) {
        ...
        if (event.getSource() == date) {
            ...
            stergere_angajat(nume1,prenume1);
